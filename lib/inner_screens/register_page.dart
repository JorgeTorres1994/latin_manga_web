...
import 'package:aplicacion_manga_admin_panel/widgets/firebase_contss.dart';
import 'package:aplicacion_manga_admin_panel/widgets/primary_button.dart';
    ...
    try {
      if (validarCampos()) {
        if (passwordConfirmed()) {
          ...
          //final _uid = user!.uid; // Obtener el ID del usuario registrado
